...
Área canônica `D22` do Programa SAS.
...
`D22-DOC-DRL-001` — Decision and Register Log do Ecossistema.
...
Os IDs desta área são estáveis e não devem ser reutilizados por outras áreas.
